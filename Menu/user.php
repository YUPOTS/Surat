...
<html>
<head>
  <title>&nbsp Aplikasi&nbspSurat&nbsp SMPN 31 &nbsp Bandar Lampung &nbsp- &nbspUser &nbsp|</title>
<meta charset="utf-8">
...
<div class="container">
	<div class="hero-unit">
		<h3><center><img src="../Images/lg31.png" class="img-thumbnail" alt="Logo" width="70" height="90">&nbsp&nbsp&nbsp Aplikasi Pengelolaan Surat SMPN 31 Bandar Lampung</center></h3>
	</div>
...
<div class="row">
	...
	<div class="col-md-9">
		<div class="headisi">
			...
			<span>Selamat Datang di Aplikasi Pengelolaan Surat SMPN 31 Bandar Lampung ! (Jam Kerja : 08.00 - 16.00 Senin s/d Jumat) </span>
			</marquee></h4></center>
		</div>
					...
					?>
								...
								<form id="formTambahSuratKeluar" class="form-horizontal" action="Process/cekBuatSuratKeluar.php" method="post">
									...
									<div class="form-group">
											...
											<div class="col-md-3 inputGroupContainer">
												<div class="input-group">
												<input type="text" name="no_agdK" id="no_agdK" class="form-control" placeholder="No. Berkas.." value="<?php echo $noDupK ?>">
