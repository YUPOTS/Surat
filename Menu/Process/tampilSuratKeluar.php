...
<?php
	...
	$dataTampil=mysql_fetch_array($qryTampil);  
     ?> 
<head>
<title>&nbsp ./Aplikasi&nbspSurat&nbsp SMPN 31 &nbsp Bandar&nbsp Lampung- &nbspTampil&nbspSurat&nbspMasuk &nbsp|</title>
<meta charset="utf-8">
			...
			<div class="modal-body" >
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title"><b>No. Berkas : <?php echo $dataTampil['no_agenda'] ; ?> (Surat Keluar)</b></h3>
					</div>
