<html>
<head>
  <title>&nbsp ./Aplikasi&nbspSurat&nbsp SMPN 31 &nbsp Bandar Lampung &nbsp- &nbspPencarian &nbsp|</title>
<meta charset="utf-8">
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h4 class="modal-title"><span class="glyphicon glyphicon-search"></span>&nbsp Pencarian No. Surat / No. Berkas</h4>	
			</div>
		<?php
			...
			<div class="modal-body" >
				...
				<div role="tabpanel">
					...
					<ul class="nav nav-tabs" role="tablist" id="tabCariNo">
						...
						<li role="presentation"><a onClick="myLoop2()" href="#TabCariNoAgendaMasuk" role="tab" data-toggle="tab"><span class="glyphicon glyphicon-th-list"></span>&nbsp (Surat Masuk) No. Berkas</a></li>
						<li role="presentation"><a onClick="myLoop2()" href="#TabCariNoAgendaKeluar" role="tab" data-toggle="tab"><span class="glyphicon glyphicon-th-list"></span>&nbsp (Surat Keluar) No. Berkas</a></li>
					</ul>
