...
<head> 
<title>&nbsp ./Aplikasi&nbspSurat&nbsp SMPN 31 &nbsp Bandar Lampung- &nbspRiwayat &nbsp Surat&nbsp Masuk&nbsp|</title>
<meta charset="utf-8">
...
<?php } ?>
      ...
      <div class="modal-footer">
		...
		<button type="button" class="btn btn-primary" data-dismiss="modal" onClick="window.location.href = 'CetakSeluruh.php'"><span class="glyphicon glyphicon-print"></span>Print</button>
      </div>
    </div>
  </div>
</div>
