<?php
	...
	$isi_dps = mysql_real_escape_string($_POST['isi_dps']);
		...
		$insert = "INSERT INTO `s_masuk` (`no_urut`,`no_agenda`,`tgl_terima`,`isi_disposisi`,`srt_no`,`srt_tgl`,`srt_dari`,`srt_perihal`) VALUES
			('".$no_urutm."','".$no_agd."','".$tgl_msk."','".$isi_dps."','".$no_suratm."','".$tgl_suratm."','".$dr_srt."','".$isi_srt."')";
		...
		{
			echo '<script type="text/javascript">alert("./Data Gagal disimpan! No. Berkas Terdeteksi Terduplikasi, Cek Kembali No. Berkas Anda! :(");window.location.href = "cekAutentikasi.php";</script>';
		}
