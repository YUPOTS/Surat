<?php  
    ...
    $update="UPDATE `s_masuk` SET `no_agenda`='".$no_agd."',`tgl_terima`='".$tgl_msk."',`isi_disposisi`='".$isi_dps."',`srt_no`='".$no_suratm."',`srt_tgl`='".$tgl_suratm."',`srt_dari`='".$dr_srt."',`srt_perihal`='".$isi_srt."' WHERE `no_urut` = '".$no_urutm."';";
