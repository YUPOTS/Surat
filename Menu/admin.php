...
<html>
<head>
<title>&nbsp Aplikasi&nbspSurat&nbsp SMPN 31 &nbsp Bandar Lampung- &nbspAdmin &nbsp|</title>
<meta charset="utf-8">
...
<div class="container">
	<div class="hero-unit">
		<h3><center><img src="../Images/lg31.png" class="img-thumbnail" alt="Logo" width="70" height="90">&nbsp &nbsp &nbspSistem Informasi Surat Kedinasan SMPN 31 Bandar Lampung</center></h3>
	</div>
...
<div class="row">
		...
		<hr>
			<center><h3><span class="glyphicon glyphicon-dashboard"></span>&nbsp Panel Menu</h3></center>
				<table class="table">
					...
					<tr><th><a href="" style="text-decoration:none" data-toggle="modal" data-target="#ppBuatSuratM" onClick="myLoop()"><span class="glyphicon glyphicon-envelope"></span> &nbsp Buat Surat Masuk</a></th></tr>
					<tr><th><a href="" style="text-decoration:none" data-toggle="modal" data-target="#ppBuatSurat" onClick="myLoop()"><span class="glyphicon glyphicon-envelope"></span> &nbsp Buat Surat Keluar</a></th></tr>
	...
	<div class="col-md-9">
		<div class="headisi">
			...
			<span>Selamat Datang di Sistem Informasi Surat Kedinasan SMPN 31 Bandar Lampung ! (Jam Kerja : 08.00 - 16.00 Senin s/d Jumat) </span>
			</marquee></h4></center>
		</div>
          ...
          <div class="panel-heading" role="tab" id="headingOne">
            <h4 class="panel-title" onClick="myLoop2()">
              ...
              <div class="panel-body">
                  ...
                  <thead>
                  <tr>
                  <td><strong><div align="center"><span class="glyphicon glyphicon-globe"></span>&nbsp No. Berkas</div></strong></td>
	...
	<div class="modal-dialog modal-xs">
		<div class="modal-content">
			...
			<div class="modal-body" >
								...
								<hr>
								<label class="col-md-12">Pencarian Berdasarkan No. Surat / No. Berkas !</label>
								<br>
								<form id="formPencarianNo" class="form-horizontal" action="Process/pencarianNo.php" method="post">
									<div class="form-group">
										<label class="col-md-3 control-label">Kata Kunci</label>
											<div class="col-md-7 inputGroupContainer">
												<div class="input-group">
										        <input type="text" name="cari_no" id="cari_no" class="form-control" placeholder="Masukkan No. Surat / No. Berkas.." >
									...
									<div class="form-group">
										<div class="col-md-offset-3 col-md-9">
											<button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-search"></span>&nbsp Cari No. Surat / No. Berkas</button>
										</div>
									</div>
								</form>
			</div>
...
<!-- Modal #ppBuatSuratM -->
<div class="modal fade" id="ppBuatSuratM" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
		
			<!-- Modal #ppBuatSuratM Header -->
			<div class="modal-header">
...
<!-- Menu BuatSuratMasukM -->
				<div role="tabpanel">
											
					<ul class="nav nav-tabs" role="tablist" id="ppSuratBaruM">
							...
							<div role="tabpanel" class="tab-pane fade in active" id="TabSuratMasuk">
								<form id="formTambahSuratMasuk" class="form-horizontal" action="Process/cekBuatSuratMasuk.php" method="post">
									...
									<div class="form-group">
											...
											<div class="col-md-3 inputGroupContainer">
												<div class="input-group">
												<input type="text" name="no_agd" id="no_agd" class="form-control" value="<?php echo $noDup ?>" placeholder="No. Berkas..">
												<span class="input-group-addon"><span class="glyphicon glyphicon-pencil"></span></span>
												</div>
											</div>
												...
												<div class="input-group hidden"  id="dwCek">
													<span class="input-group-addon"><span class="glyphicon glyphicon-check"></span></span>
														<select class="form-control" name="level" id="dwVal">
															<option value="" selected>No.Berkas</option>
...
<!-- Modal #ppBuatSurat #ppSuratBaruM Footer -->
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" data-dismiss="modal" onClick="myLoop()"><span class="glyphicon glyphicon-remove"></span> Tutup</button>
			</div>
		</div>
    ...
    $('#formTambahSuratMasuk').formValidation({
        ...
        fields: {
			...
			no_agd: {
                ...
                validators: {
                    notEmpty: {
                        message: 'Anda belum memasukkan "No. Berkas" !'
                    },
                }
            },
			tgl_msk: {
    ...
    $('#formPencarianNo').formValidation({
        ...
        fields: {
			cari_no: {
                ...
                validators: {
                    notEmpty: {
                        message: 'Anda belum memasukkan "No. Surat / No. Berkas" !'
                    },
                }
            },
			captcha: {
